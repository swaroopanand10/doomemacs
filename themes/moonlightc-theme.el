;;; moonlightc-theme.el --- inspired by VS code's Moonlight -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;;
(defgroup moonlightc-theme nil
  "Options for the `moonlightc' theme."
  :group 'doom-themes)

(defcustom moonlightc-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'moonlightc-theme
  :type '(choice integer boolean))

;;
(def-doom-theme moonlightc
  ...
  ((bg         '("#000000" "#000000"  "black"))
   ...
   (-modeline-pad
    (when moonlightc-padded-modeline
      (if (integerp moonlightc-padded-modeline) moonlightc-padded-modeline 4))))
